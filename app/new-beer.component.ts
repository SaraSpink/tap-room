...
@Component({
  ...
  <div class="well">
    ...
    <input #newBeerAbv>
    <button (click)="submitForm(newBeerName.value, newBeerBrand.value, newBeerPrice.value, newBeerAbv.value) newBeerName.value=''; newBeerBrand.value=''; newBeerPrice.value=''; newBeerAbv.value='';">Add Beer</button>
  </div>
  `
})
